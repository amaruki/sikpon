    ...
    <table width="100%" class="tblcms2">
        <tbody>
            <tr>
                ...
                <th align="center" class="th_border cell">Mapel</th>
        ...
        <tbody>
            @forelse ($laporan as $row)
                <tr class="event2">
                    ...
                    <td align="center">{{ $row->mapel->kelas->kelas ?? '-' }} {{ $row->mapel->kelas->nama ?? '-' }}</td>
                    <td align="center">{{ $row->mapel->nama }}</td>
