                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('guru_id') is-invalid @enderror" 
                                        ...
                                        @foreach($guru as $g)
                                            <option value="{{ $g->id }}" {{ (old('guru_id', auth()->user()->role === 'guru' ? auth()->id() : null) == $g->id) ? 'selected' : '' }}>
                                                {{ $g->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('evaluasi_pembelajaran') is-invalid @enderror" 
                                              ...
                                              required>{{ old('evaluasi_pembelajaran') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('catatan_khusus') is-invalid @enderror" 
                                              id="catatan_khusus" name="catatan_khusus" rows="3">{{ old('catatan_khusus') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('kendala_pembelajaran') is-invalid @enderror" 
                                              id="kendala_pembelajaran" name="kendala_pembelajaran" rows="3">{{ old('kendala_pembelajaran') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('solusi_kendala') is-invalid @enderror" 
                                              id="solusi_kendala" name="solusi_kendala" rows="3">{{ old('solusi_kendala') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('pencapaian_target') is-invalid @enderror" 
                                        ...
                                        <option value="sebagian" {{ old('pencapaian_target') === 'sebagian' ? 'selected' : '' }}>Sebagian</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('keterangan_pencapaian') is-invalid @enderror" 
                                              id="keterangan_pencapaian" name="keterangan_pencapaian" rows="3">{{ old('keterangan_pencapaian') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_jurnal') is-invalid @enderror" 
                                        ...
                                        <option value="draft" {{ old('status_jurnal') === 'draft' ? 'selected' : '' }}>Draft</option>
