            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('jurnal.show', $jurnal->id) }}" class="btn btn-info btn-sm">
                ...
                <form action="{{ route('jurnal.update', $jurnal->id) }}" method="POST" id="formJurnal">
                    ...
                    <div class="card-body">
                        ...
                        @if($jurnal->status_jurnal === 'final' && Auth::user()->role !== 'admin')
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle"></i>
                                <strong>Perhatian:</strong> Jurnal ini sudah berstatus final dan tidak dapat diubah.
                            </div>
                        @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" 
                                           id="tanggal" name="tanggal" value="{{ old('tanggal', $jurnal->tanggal) }}" required>
                                    @error('tanggal')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('mata_pelajaran_id') is-invalid @enderror" 
                                        ...
                                        @foreach($mataPelajaran as $mp)
                                            <option value="{{ $mp->id }}" 
                                                {{ (old('mata_pelajaran_id', $jurnal->mata_pelajaran_id) == $mp->id) ? 'selected' : '' }}>
                                                {{ $mp->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('kegiatan_pembelajaran') is-invalid @enderror" 
                                              ...
                                              placeholder="Deskripsikan kegiatan pembelajaran yang dilakukan" required>{{ old('kegiatan_pembelajaran', $jurnal->kegiatan_pembelajaran) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('evaluasi_pembelajaran') is-invalid @enderror" 
                                              ...
                                              placeholder="Evaluasi hasil pembelajaran dan pemahaman siswa" required>{{ old('evaluasi_pembelajaran', $jurnal->evaluasi_pembelajaran) }}</textarea>
                                                        ...
                                                        @foreach($santriKelas as $santri)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" name="santri_hadir[]" 
                                                                       ...
                                                                       {{ in_array($santri->id, old('santri_hadir', $jurnal->santri_hadir ?? [])) ? 'checked' : '' }}>
                                                        ...
                                                        @foreach($santriKelas as $santri)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" name="santri_tidak_hadir[]" 
                                                                       ...
                                                                       {{ in_array($santri->id, old('santri_tidak_hadir', $jurnal->santri_tidak_hadir ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('pencapaian_target') is-invalid @enderror" 
                                        ...
                                        <option value="sebagian" {{ old('pencapaian_target', $jurnal->pencapaian_target) == 'sebagian' ? 'selected' : '' }}>Sebagian Tercapai</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_jurnal') is-invalid @enderror" 
                                            ...
                                            {{ ($jurnal->status_jurnal === 'final' && Auth::user()->role !== 'admin') ? 'disabled' : '' }}>
                                    ...
                                    @if($jurnal->status_jurnal === 'final' && Auth::user()->role !== 'admin')
                                        <input type="hidden" name="status_jurnal" value="{{ $jurnal->status_jurnal }}">
                                    @endif
                                    @error('status_jurnal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('keterangan_pencapaian') is-invalid @enderror" 
                                              ...
                                              placeholder="Jelaskan detail pencapaian target pembelajaran">{{ old('keterangan_pencapaian', $jurnal->keterangan_pencapaian) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('catatan_khusus') is-invalid @enderror" 
                                              ...
                                              placeholder="Catatan khusus terkait pembelajaran">{{ old('catatan_khusus', $jurnal->catatan_khusus) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('kendala_pembelajaran') is-invalid @enderror" 
                                              ...
                                              placeholder="Kendala yang dihadapi saat pembelajaran">{{ old('kendala_pembelajaran', $jurnal->kendala_pembelajaran) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('solusi_kendala') is-invalid @enderror" 
                                              ...
                                              placeholder="Solusi untuk mengatasi kendala">{{ old('solusi_kendala', $jurnal->solusi_kendala) }}</textarea>
                    ...
                    <div class="card-footer">
                        ...
                        @if($jurnal->status_jurnal === 'draft' && (Auth::user()->role === 'admin' || $jurnal->guru_id === Auth::user()->id))
                            <a href="{{ route('jurnal.finalisasi', $jurnal->id) }}" class="btn btn-success"
                        ...
                        <a href="{{ route('jurnal.show', $jurnal->id) }}" class="btn btn-info">
                            <i class="fas fa-eye"></i> Lihat
                        </a>
...
$(document).ready(function() {
    ...
    // Load santri when kelas changed
    $('#kelas_id').change(function() {
        var kelasId = $(this).val();
        if (kelasId && kelasId != '{{ $jurnal->kelas_id }}') {
            if (confirm('Mengubah kelas akan mereset data kehadiran santri. Apakah Anda yakin?')) {
                loadSantriByKelas(kelasId);
            } else {
                $(this).val('{{ $jurnal->kelas_id }}').trigger('change');
            }
        }
    });
    ...
    // Disable form if final and not admin
    @if($jurnal->status_jurnal === 'final' && Auth::user()->role !== 'admin')
