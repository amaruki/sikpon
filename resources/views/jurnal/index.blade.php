                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-{{ $j->status === 'published' ? 'success' : 'warning' }}">
                                            {{ ucfirst($j->status) }}
                                        </span>
                                    </td>
                                    <td>
                                        <a href="{{ route('jurnal.show', $j->id) }}" class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        @if(in_array(auth()->user()->role, ['admin', 'guru']) && (auth()->user()->role === 'admin' || auth()->id() === $j->guru_id))
